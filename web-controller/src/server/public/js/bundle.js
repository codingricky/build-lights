...
function reorderJob(a, b) {
  var currentState = JSON.parse(window.localStorage.getItem('currentState'));
  var toolIdx = index(currentState, { name: 'jobs to monitor' });
  var jobs = currentState[toolIdx].configuration.items;
...
function upgrade() {
  ...
  fetch('/upgrade').then(function (res) {
    return res.json();
  }).then(function (json) {
    render(represent(json));
  }).catch(function (err) {
...
var CiTabContent = function CiTabContent(model) {
  ...
  var username = isToolOneOf(['bamboo', 'buildkite', 'circleci', 'travisci']) ? bp4$1([bp5$1(usernameLabels[model.configuration.tool]), bp6({
    type: 'text',
    id: 'ciUsername',
    name: 'ciUsername',
  ...
  var apiToken = isToolOneOf(['buildkite', 'circleci', 'tabletennis']) ? bp10([bp11('API token'), bp12({
    type: 'text',
    id: 'ciApiToken',
    placeholder: '',
    name: 'ciApiToken',
  ...
  }, [bp18('Bamboo'), bp19('Buildkite'), bp20('Circle CI'), bp21('Jenkins'), bp22('Travis CI'), bp23('Table Tennis')]), address, username, password, apiToken]), bp24([bp25('Save'), bp26(['Last updated: ', model.lastUpdated])])]);
};
...
var JobsTabContent = function JobsTabContent(model) {
  ...
  return bp1$5({
    onsubmit: handleFormSubmit
  }, [bp2$4([bp3$3(['Rate to ', bp4$2('poll your CI server'), ' (in seconds)']), bp5$2({
    type: 'number',
    name: 'pollRate',
    id: 'pollRate',
    value: model.configuration.pollrate
  })]), bp6$1([bp7$1(bp8$1('Monitored jobs')), jobs, bp9$1({
    type: 'button'
  }, {
    onclick: autoDiscoverJobs
  }, 'Auto discover jobs')]), bp10$1([bp11$1('Save'), bp12$1(['Last updated: ', model.lastUpdated])])]);
};
...
var bp26$1 = inferno.createBlueprint({
  tag: 'input',
  attrs: {
    arg: 0
  }
...
var NetworkTabContent = function NetworkTabContent(model) {
  ...
  return bp0$8({
  ...
  })]), bp5$4([bp6$3([bp7$2(['Select your ', bp8$2('preferred connection type')]), bp9$2([bp10$2({
    type: 'radio',
    name: 'connectionType',
  ...
  }), bp27([bp28(bp29()), 'Hidden network?'])])])]), bp30([bp31([bp32([bp33('IP address'), ' assignment']), bp34([bp35({
    type: 'radio',
    name: 'useDhcp',
  ...
  }), bp36([bp37(bp38()), 'Static (manual)']), bp39({
    type: 'radio',
    name: 'useDhcp',
    checked: model.configuration.dhcp ? 'checked' : '',
    value: 'true',
    ...
    onchange: handleDhcpChange
  }), bp40([bp41(bp42()), 'DHCP (dynamic)'])])]), bp43('static-configuration ' + staticContainerHidden, [bp44([bp45('Address'), bp46({
    type: 'text',
    name: 'address',
    id: 'address',
    value: model.configuration.address,
...
var LedHardwareTabContent = function LedHardwareTabContent(model) {
  ...
  }, [bp5$5('Epistar LPD8806'), bp6$4('Adafruit LPD8806')]), bp7$3('Number of LEDs on your strip'), bp8$3({
    type: 'number',
    required: true,
    id: 'numLeds',
    name: 'numLeds',
...
__$styleInject(".Spinner svg path,\n    .Spinner svg rect {\n    stroke: #192854;\n}\n.SpinnerOverlay {\n    position: fixed;\n    top: 0;\n    bottom: 0;\n    left: 0;\n    right: 0;\n    z-index: 100;\n    width: 100%;\n    height: 100%;\n    background: rgba(0, 0, 0, .15);\n    display: -ms-flexbox;\n    display: -webkit-box;\n    display: flex;\n    -ms-flex-pack: center;\n            -webkit-box-pack: center;\n        justify-content: center;\n    -ms-flex-align: center;\n            -webkit-box-align: center;\n        align-items: center;\n}\n", undefined);
...
var Spinner = function Spinner() {
  return bp0$10(bp1$9(bp2$8(bp3$7())));
};
...
var SpinnerOverlay = function SpinnerOverlay() {
  return bp4$6(bp5$6(Spinner));
};
...
var bp17$2 = inferno.createBlueprint({
  tag: 'span',
  children: {
    arg: 0
  }
});
var bp16$2 = inferno.createBlueprint({
  tag: 'div',
  className: 'container',
  children: {
    arg: 0
...
var bp15$2 = inferno.createBlueprint({
  tag: 'header',
  children: {
    arg: 0
  }
...
var Header = function Header(model) {
  ...
  var upgradeSoftware = function upgradeSoftware() {
    return upgrade();
  };

  var deviceActionsMenu = bp0$11([bp1$10('Menu'), bp2$9([bp3$8(bp4$7({
    href: '#'
  }, {
  ...
  }, 'Upgrade software')), bp11$4(bp12$3()), bp13$2(bp14$2({
    id: 'supervisor',
    target: '_blank',
    href: supervisorHref
  }, 'Supervisor'))])]);
  ...
  return bp15$2(bp16$2([bp17$2('Build Lights'), deviceActionsMenu]));
};

__$styleInject("footer {\n    background: #A3A9AC;\n    font-size: 0.75em;\n    padding: 0.625em;\n    text-align: center;\n}\nfooter div {\n    padding: 0.5em 0;\n}\nfooter div a {\n    text-decoration: underline;\n}\n", undefined);
...
var bp5$8 = inferno.createBlueprint({
  tag: 'a',
  attrs: {
...
var Footer = function Footer() {
  return bp0$12([bp1$11([bp2$10('DiUS'), ' \xA9 2016 - All rights reserved.']), bp3$9(['Icons made by ', bp4$8('Gregor Cresnar'), ' from ', bp5$8('www.flaticon.com'), ' is licensed by ', bp6$6('CC 3.0 BY')])]);
};

var bp2$11 = inferno.createBlueprint({
  tag: 'small',
  children: {
    arg: 0
  }
});
var bp1$12 = inferno.createBlueprint({
  tag: 'br'
});
var bp0$13 = inferno.createBlueprint({
  tag: 'p',
  children: {
    arg: 0
  }
});
var bp5$9 = inferno.createBlueprint({
  tag: 'small',
  children: {
    arg: 0
  }
});
var bp4$9 = inferno.createBlueprint({
  tag: 'br'
});
var bp3$10 = inferno.createBlueprint({
  tag: 'p',
  children: {
    arg: 0
  }
...
var Intermission = function Intermission(model) {
  var message = bp0$13(['Shutdown underway. ', bp1$12(), ' ', bp2$11(['You can safely unplug your Raspberry Pi in ', model.countdown, ' seconds.'])]);

  if (model.reboot) {
    message = bp3$10(['Reboot underway. ', bp4$9(), ' ', bp5$9(['Will refresh in ', model.countdown, ' seconds.'])]);
  }
